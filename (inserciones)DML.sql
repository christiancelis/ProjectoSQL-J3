...
INSERT INTO Vehiculo (id, Placa, Kilometraje, idCliente, idMarca, idModelo) VALUES
(1, 'ABC123',25522, 1, 1, 1),
(2, 'DEF456',32000, 2, 2, 2),
(3, 'GHI789',45000 ,3, 3, 3),
(4, 'JKL012',12000, 4, 4, 4),
(5, 'MNO345',342100, 5, 5, 5),
(6, 'PQR678',12300, 6, 6, 6),
(7, 'STU901',56000, 7, 7, 7),
(8, 'VWX234',32000, 8, 8, 8),
(9, 'YZA567',34000,9, 9, 9),
(10, 'BCD890',56000, 10, 10, 10),
(11, 'EFG123',54000, 11, 1, 1),
(12, 'HIJ456',23000,12, 2, 2),
(13, 'KLM789',25000, 13, 3, 3),
(14, 'NOP012',98000,14, 4, 4),
...
(1, 'Cambio de aceite', 'Cambio de aceite y filtro', 80000),
(2, 'Revisión general', 'Revisión de motor y sistemas', 120000),
(3, 'Cambio de llantas', 'Cambio de llantas y alineación', 150000),
(4, 'Frenos', 'Revisión y ajuste de frenos', 100000),
(5, 'Reparación de motor', 'Reparación completa de motor', 300000),
(6, 'Aire acondicionado', 'Recarga y mantenimiento del aire acondicionado', 50000),
(7, 'Suspensión', 'Revisión y ajuste de suspensión', 80000),
(8, 'Electricidad', 'Revisión y reparación de sistema eléctrico', 70000),
(9, 'Cambio de batería', 'Cambio de batería y revisión', 60000),
(10, 'Transmisión', 'Reparación y ajuste de transmisión', 200000),
(11, 'Reparación de carrocería', 'Reparación de golpes y daños en la carrocería', 250000),
(12, 'Sistema de frenos ABS', 'Reparación y ajuste del sistema ABS', 120000),
(13, 'Sistema de dirección', 'Revisión y ajuste del sistema de dirección', 90000),
(14, 'Cambio de líquidos', 'Cambio de líquidos y fluidos', 70000),
...
(1, '2024-06-06 08:00:00', 1,1),
(2, '2024-06-08 09:30:00', 2,2),
(3, '2024-06-10 11:00:00', 3,3),
(4, '2024-06-12 13:30:00', 4,4),
(5, '2024-06-14 15:00:00', 5,5),
(6, '2024-06-16 16:30:00', 6,6),
(7, '2024-06-18 18:00:00', 7,7),
(8, '2024-06-20 19:30:00', 8,8),
(9, '2024-06-22 21:00:00', 9,9),
(10, '2024-06-24 22:30:00', 10,10),
(11, '2024-06-26 08:00:00', 11,11),
(12, '2024-06-28 09:30:00', 12,12),
(13, '2024-06-30 11:00:00', 13,13),
(14, '2024-07-02 13:30:00', 14,14),
...
INSERT INTO Reparacion_pieza (id,cantidad, idReparacion, idPieza) VALUES
(1,3, 1, 1),
(2,10, 2, 2),
(3,3, 3, null),
(4,7, 4, 4),
...
(1, '2024-06-06', 50000, 1, 1),
(2, '2024-06-08', 160000, 2, 2),
(3, '2024-06-10', 120000, 3, 3),
(4, '2024-06-12', 120000, 4, 4),
(5, '2024-06-14', 70000, 5, 5),
(6, '2024-06-16', 450000, 6, 1),
(7, '2024-06-18', 80000, 7, 2),
(8, '2024-06-20', 90000, 8, 3),
(9, '2024-06-22', 100000, 9, 4),
(10, '2024-06-24', 30000, 10, 5);
